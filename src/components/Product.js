  ...
  return (
    <div className='Product'>
      <Helmet>
        ...
        <link rel='alternate' href={`https://angelebrousse.com/fr/${product.slug}`} hreflang='fr' />
        <link
          rel='alternate'
        ...
        <link
          ...
          hreflang='fr-CH'
        />
        <link rel='alternate' href={`https://angelebrousse.com/en/${product.slug}`} hreflang='en' />
        <link
          rel='alternate'
