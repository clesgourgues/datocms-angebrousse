window.Snipcart.execute('registerLocale', 'fr-FR', {
  ...
  country: 'Country',
  subtotal: 'Subtotal',
  tax_adjustments: 'Tax adjustments',
  rebate: 'Rebate',
  ...
  payment_method_card_exp_date: 'Expiration date',

  payment_method_card_postal_code: 'Postal code',
  ...
  reset_password_changed: 'Your password has been changed.',
  ...
  errors_passwords_dont_match: 'Both passwords must match',

  errors_email_must_be_unique: 'A user with the same email already exists',
  ...
  errors_invalid_authentication_infos: 'Invalid authentication information',
  ...
  shipping_method_delivery_time: 'By {0}', // By 2013-11-28
  ...
  cart_plans_interval_count: 'Count',
  ...
  to_be_paid_later: 'To be paid later',
  ...
  upcoming_payment_shipping: 'Shipping',
  ...
  subscriptions_history_no_subscriptions: "You don't have any subscriptions yet.",

  orders_history_no_orders: "You don't have any orders yet.",
  ...
  subscriptions_fetching_details: 'Loading subscription details...',
  ...
  subscription_plan_interval_count: 'Plan interval count',
  ...
  plan_amount_per_day_plural: '{0} / {1} days',
  plan_amount_per_week_plural: '{0} / {1} weeks',
  plan_amount_per_month_plural: '{0} / {1} months',
  plan_amount_per_year_plural: '{0} / {1} years',
  plan_days_of_trial: '{0} days trial',
  subscription_cancel_button: 'Cancel',
  subscription_pause_button: 'Pause',
  ...
  error_item_stock_exceeded: 'Sorry! Your request exceeds the available stock for this item.',
  ...
  error_must_select_shipping_rate: 'You must select shipping method to continue.',
  back_to_orders: 'Back to orders',
  manage_subscriptions: 'Manage subscriptions',
  back_to_subscriptions_list: 'Back to subscriptions list',
  back_to_subscription_details: 'Back to subscription details',
  discount_remove_confirmation_msg: 'Are you sure you want to remove the discount?',
  digital_files_not_found:
    "One or more digital files don't exist, contact the store owner for further details.",
  digital_files_download_button: 'Download file',
  notifications_item_not_modified_due_to_min_quantity:
    'Sorry, you need to order at least {0} of this product.',
  subscription_resume_buttom: 'Resume',
  ...
  subscription_notifications_pause_confirm: 'Are you sure you want to pause your subscription?',
  subscription_notifications_resume_confirm: 'Are you sure you want to resume this subscription?',
  subscription_status_canceled: 'Canceled',
  subscription_status_paused: 'Paused',
  refund_line: 'Refunded',
  ...
  stripe_invalid_swipe_data: "The card's swipe data is invalid.",
  ...
  profile_credit_card: 'Credit card',
  profile_current_credit_card: 'Your current credit card ends with {0} and expires on {1} / {2}.',
  profile_update_card: 'Click here to update it',
  profile_saved_successfully: 'Your profile has been saved successfully.',
  profile_loading: 'Getting your profile information...',
  profile_saving: 'Saving your profile...',
  profile_billing_address: 'Billing address',
  profile_shipping_address: 'Shipping address',
  profile_edit_linktitle: 'Click here to edit your profile.',
  ...
  profile_edit_link: '{0}',
  square_field_cardnumber: 'Card Number',
  square_field_cvv: 'CVC',
  square_field_postalcode: 'Postal Code',
  square_field_expirationdate: 'Expiration Date',
  square_validation_error: '{0} is invalid',
  square_missing_card_data: 'One or more card data fields was not filled out in the payment form.',
  square_unknown: 'An unknown error occurred during card validation. Please try again later.',
  ...
  preparing_payment: 'Getting things ready...',
  ...
  error_subscription_payment_failed: 'This card was not accepted. Please try a different card.',
  payment_error_form_init:
    "Apologies - unexpected error occurred. No payment processed, we're looking into it. Try again later.",
  wait_few_seconds: 'Just a few seconds...'
});
